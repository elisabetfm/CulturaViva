...
void draw(){
  ...
  fill(0);
  text("acontecimientos recientes1", 2*margenH + acontecimientos1Width/2, 2*margenV + bannerHeight + margenH + filtrosHeight + acontecimientos1Height/2 + 10);
  ...
  fill (0);
  text ("Acontecimientos recientes2", 2*margenH + logoWidth + (bannerWidth-acontecimientos2Width) + acontecimientos2Width/2, 2*margenV + bannerHeight + margenH + filtrosHeight + acontecimientos2Height/2 + 10);
  ...
  fill(0);
  text("Indicador de páginas", 2*margenH + acontecimientos1Width + indicadorWidth/2, 2*margenV + bannerHeight + filtrosHeight + acontecimientos1Height + margenV + indicadorHeight/2 + 10);
